    ...
    <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td align="center" style="background-color: #000000;"><![endif]-->
                        ...
                        <div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
                            <div style="width: 100% !important;">
                                ...
                                <div
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding"
                                                ...
                                                <h1 class="v-font-size"
                                                    style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Montserrat',sans-serif; font-size: 38px;">
                                                    <strong>Codana-Eventplanner</strong>
                                                </h1>
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding"
                                                ...
                                                <div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px;"><span
                                                                style="line-height: 25.2px; font-family: 'Montserrat', sans-serif; font-size: 18px;">Welcome to Codana-eventplanner. Here u can see all upcoming events that will take place in your company.</span></span>
                                                    </p>
                                                </div>
                                    ...
                                    <table id="u_content_button_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0"
                                           cellspacing="0" width="100%" border="0">
                                        <tbody>
                                        <tr>
                                            <td class="v-container-padding-padding"
                                                        ...
                                                        <tr>
                                                            <td style="font-family:arial,helvetica,sans-serif;" align="center">
                                                                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                             xmlns:w="urn:schemas-microsoft-com:office:word" href="https://unlayer.com"
                                                                             style="height:39px; v-text-anchor:middle; width:141px;" arcsize="77%" stroke="f"
                                                                             fillcolor="#14b99f">
                                                                    <w:anchorlock/>
                                                                    <center style="color:#FFFFFF;font-family:arial,helvetica,sans-serif;"><![endif]-->
                                                    <a href="https://codana-eventplanner.web.app/" target="_blank"
                                                       style="box-sizing: border-box;display: inline-block;font-family:arial,helvetica,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #14b99f; border-radius: 30px;-webkit-border-radius: 30px; -moz-border-radius: 30px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                                        <span class="v-padding" style="display:block;padding:10px 20px;line-height:120%;"><strong><span
                                                                    style="font-size: 16px; line-height: 19.2px;">Eventplanner</span></strong></span>
                                                    </a>
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding"
                                                ...
                                                <h1 class="v-font-size"
                                                    ...
                                                    ICS/ICAL link to all events that u will host or attend
                                                </h1>
            ...
            <div class="u-row-container" style="padding: 0px 0px 20px;background-color: transparent">
                <div class="u-row"
                    ...
                    <div style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td style="padding: 0px 0px 20px;background-color: transparent;" align="center">
                                    <table cellpadding="0" cellspacing="0" border="0" style="width:600px;">
                                        <tr style="background-color: transparent;"><![endif]-->
                                            ...
                                            <td class="v-container-padding-padding"
                                                ...
                                                <div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 140%;"><strong><span
                                                                style="text-decoration: underline; font-size: 14px; line-height: 19.6px;">${icalLink}</span></strong>
                                                    </p>
                                                </div>
...
export async function sendMailPerEvent(
user: User,
event: Event,
icalLink?: string
) {
...
to: user.email,
message: {
subject: `Nice to see you attending ${event.name}!`,
                                    ...
                                    <table id="u_content_text_1" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0"
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding"
                                                ...
                                                <div style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                    <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px;"><span
                                                                style="line-height: 25.2px; font-family: 'Montserrat', sans-serif; font-size: 18px;">You are attending ${event.name}, below you can see an ics/ical Link you can add to your personal calender!</span></span>
                                                    </p>
                                                </div>
                                    ...
                                    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                        ...
                                        <tr>
                                            <td class="v-container-padding-padding"
                                                ...
                                                <h1 class="v-font-size"
                                                    style="margin: 0px; color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Montserrat',sans-serif; font-size: 22px;">
                                                    ics/ical link to ${event.name} make sure you add it to your calender so you wont miss it!
                                                </h1>
